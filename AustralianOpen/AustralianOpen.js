...
export default class AustralianOpen extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("costume1", "./AustralianOpen/costumes/costume1.svg", {
        x: 144.32811499999997,
        y: 47.249989687500005
      })
    ];

    this.sounds = [new Sound("pop", "./AustralianOpen/sounds/pop.wav")];
